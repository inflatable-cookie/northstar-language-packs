...
Roadmap: `g01.002`
Card: `g01.002/004`
Result: source candidate ready for review-only PR
...
`69e4d5dea3daa4f6133d7363d39c1a0f72848435` with listing digest
`2f8515afce33c87e9b38f103b9c41440ed7f182142fc2c65fed4d10d9264040b`.

The package provides standalone manifests, catalogues, agent adapter metadata,
setup Rhai script with relay argument forwarding, package QA validation with
negative oracles, Cargo engine unit/integration tests, tamper rejection, and
...
| Engine is independent and verified. | 27 Cargo unit and integration tests run; probe binary installed and `verify-install` validates source payload; mutating `src/lib.rs`, `Cargo.toml`, or `diagnostic-mapping.json` fails closed with `install.payload_mismatch`. | Cargo test suite passes; probe verification passes; tamper negatives fail closed. |
...
- source listing digest (54 files):
  `2f8515afce33c87e9b38f103b9c41440ed7f182142fc2c65fed4d10d9264040b`
- package file count:
  `59`
- package-tree listing digest (59 files):
  `sha256:a1fc60fce67ec0800e425d93e6c63f2e0675787fbf726b31be9e04ac0c537a3b`
- manifest digest (`northstar-package.json`):
  `sha256:dd71d04efd67cc7805f417a79666dd920ea1811ee252d941108dfbeca8aab612`
- engine file count:
  `22`
- engine Cargo tree digest (`tools/rust-quality`):
  `sha256:46df2d0d11286885b2c9a5dfb20f52232091519c357486bc7a1aea4d05cb83c2`
- engine payload digest (`embedded_payload_sha256`):
  `sha256:2b75b0866e3bedf99c133e53cb742c284715fb1f10f589358ce2a91331571157`
...
- `effigy --repo packages/rust check:rust-quality` passed (7 rules, 14 qualified detector candidates, 59-file inventory, 9 catalogue/manifest, 7 grammar, 1 existence, 1 exact-command negative paths).
...
- `effigy --repo packages/rust test:rust-quality-installed-route` passed (public skill-run setup, relay sentinel, decoy catalogue ignored, engine cargo tests and tamper rejection, probe verify-install, adapter grammar and exact-command closure enforced).
...
Open review-only pull request and stop for review.
