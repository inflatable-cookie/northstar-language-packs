...
title: "Flatten Northstar tasks and compact historic generations in northstar-language-packs"
...
Run the one-time Northstar flattened-task switchover in `northstar-language-packs`. Compact
...
- Integration checkout: `/Users/tom/Dev/projects/northstar-language-packs` on clean, synchronized `main` at the commit
